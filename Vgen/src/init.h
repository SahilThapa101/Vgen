...
void init_piece_bb() {
    ...
    pieceBB[0][KING] = 0x0000000000000010U;
    pieceBB[0][QUEEN] = 0x0000000000000008U;
    pieceBB[0][BISHOPS] = 0x0000000000000024U;
    pieceBB[0][KNIGHTS] = 0x0000000000000042U;
    pieceBB[0][ROOKS] = 0x0000000000000081U;
    pieceBB[0][PAWNS] = 0x000000000000FF00U;
    pieceBB[0][PIECES] = 0x000000000000FFFFU;
    
    pieceBB[1][KING] = 0x1000000000000000U;
    pieceBB[1][QUEEN] = 0x0800000000000000U;
    pieceBB[1][BISHOPS] = 0x2400000000000000U;
    pieceBB[1][KNIGHTS] = 0x4200000000000000U;
    pieceBB[1][ROOKS] = 0x8100000000000000U;
    pieceBB[1][PAWNS] = 0x00FF000000000000U;
    pieceBB[1][PIECES] = 0xFFFF000000000000U;
